...
# reads inputs ENDO
inpEndo = pd.read_csv(
    os.path.join(data_path, "Irradiance_features_day-ahead.csv"),
    delimiter=",",
    parse_dates=True,
    index_col=0,
)
# reads inputs EXO
inpExo = pd.read_csv(
    os.path.join(data_path, "NAM_nearest_node_day-ahead.csv"),
    delimiter=",",
    parse_dates=True,
    index_col=0,
)
# reads target
tar = pd.read_csv(
    os.path.join(data_path, "Target_day-ahead.csv"),
    delimiter=",",
    parse_dates=True,
    index_col=0,
)
