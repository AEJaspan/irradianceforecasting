...
# reads inputs ENDO
inpEndo = pd.read_csv(
    os.path.join(data_path, "Irradiance_features_intra-day.csv"),
    delimiter=",",
    parse_dates=True,
    index_col=0,
)
# reads inputs EXO
inpExo = pd.read_csv(
    os.path.join(data_path, "Sat_image_features_intra-day.csv"),
    delimiter=",",
    parse_dates=True,
    index_col=0,
)
# reads target
tar = pd.read_csv(
    os.path.join(data_path, "Target_intra-day.csv"),
    delimiter=",",
    parse_dates=True,
    index_col=0,
)
