...
inpEndo = pd.read_csv(
    os.path.join(data_path, "Irradiance_features_intra-hour.csv"),
    delimiter=",",
    parse_dates=True,
    index_col=0,
)
...
inpExo = pd.read_csv(
    os.path.join(data_path, "Sky_image_features_intra-hour.csv"),
    delimiter=",",
    parse_dates=True,
    index_col=0,
)
# reads target
tar = pd.read_csv(
    os.path.join(data_path, "Target_intra-hour.csv"),
    delimiter=",",
    parse_dates=True,
    index_col=0,
)
